...
// Se usa Creator ya que se crea una instancia de Hobbit.
...
{
    public class HobbitHandler : TypeHandler
    {
        public HobbitHandler(TypeHandler nextHandler) : base(nextHandler)
        {
        }
