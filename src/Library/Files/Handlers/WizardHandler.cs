...
// Se usa Creator ya que se crea una instancia de Wizard.
...
{
    public class WizardHandler : TypeHandler
    {
        public WizardHandler(TypeHandler nextHandler) : base(nextHandler)
        {
        }
        ...
        {   
            ...
            Wizard wizard = new Wizard(values[0],Convert.ToInt32(values[1]),Convert.ToInt32(values[2]),Convert.ToInt32(values[3]));

            handlerRequest.ListOfCharacter.Add(wizard);
