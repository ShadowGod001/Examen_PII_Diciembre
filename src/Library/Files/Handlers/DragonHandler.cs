...
// Se usa Creator ya que se crea una instancia de Dragon.
...
{
    public class DragonHandler : TypeHandler
    {
        public DragonHandler(TypeHandler nextHandler) : base(nextHandler)
        {
        }
        ...
        {   
            ...
            Dragon dragon = new Dragon(values[0],Convert.ToInt32(values[1]),Convert.ToInt32(values[2]),Convert.ToInt32(values[3]));

            handlerRequest.ListOfCharacter.Add(dragon);
